 ...
 */
@WebServlet(name = "Servlet_sellVehicle")
public class Servlet_sellVehicle extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try{
            ...
            PreparedStatement stmt=con.prepareStatement("select units FROM vehicle where vehicle_id=?");
            stmt.setString(1,veh);
            ResultSet rs=stmt.executeQuery();
            if(rs.next()){

                Integer t= rs.getInt(1)-unit1;
//               out.print(t);
                PreparedStatement stm=con.prepareStatement("update vehicle set units=? where vehicle_id=?");
                stm.setInt(1,t);
                stm.setString(2,veh);
                stm.executeUpdate();
                ...
                stmt1.setString(3,"sold vehicle");
